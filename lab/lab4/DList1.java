...
public class DList1 {
  ...
  public void insertFront(int i) {
    ...
    size++;
    assert size == countLength(): "WRONG, SIZE NOT MATCH...";
  }
  ...
  /** helper function to calculate the length, used with assert to check size */
  private int countLength() {
    int count = 0;
    for(DListNode1 node = head; node != null; node = node.next) count++;
    return count;
  }
