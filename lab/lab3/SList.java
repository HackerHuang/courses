...
public class SList {
    ...
    private SListNode tail; //maintain a "tail" SListNode in an SList
    private int size;
	...
	// when adding 1st SListNode, modify the "tail"
	...
	*/
	...
	SList lst = new SList();
	lst.insertEnd(new Integer(6));
	lst.insertEnd(new Integer(9));
	lst.insertEnd(new Integer(12));
	System.out.println("Here is a list after insertEnd 6, 9, 12: " + lst);
	lst.insertFront(new Integer(3));
	lst.insertEnd(new Integer(15));
	System.out.println("Adding more lines by insertFront 3, insertEnd 15: " + lst);
