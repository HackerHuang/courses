...
public class Homework3 {
  ...
  public static void main(String[] args) {
    ...
    TestHelper.verify(new Integer(8).equals(list5.length()),
                      "SIZE NOT EQUAL!!!");
    ...
    TestHelper.verify(result.equals("[  6  3  6  3  6  3  ]"),
                      "BAD SQUISH!!!  No biscuit.");
    TestHelper.verify(new Integer(6).equals(list6.length()),
                      "SIZE NOT EQUAL!!!");
    ...
    TestHelper.verify(result.equals("[  4  ]"),
                      "BAD SQUISH!!!  No biscuit.");
    TestHelper.verify(new Integer(1).equals(list7.length()),
                      "SIZE NOT EQUAL!!!");
    ...
    TestHelper.verify(result.equals("[  0  1  2  3  4  5  6  ]"),
                      "BAD SQUISH!!!  No biscuit.");
    TestHelper.verify(new Integer(7).equals(list8.length()),
                      "SIZE NOT EQUAL!!!");
    ...
    TestHelper.verify(result.equals("[  ]"),
                      "BAD SQUISH!!!  No biscuit.");
    TestHelper.verify(new Integer(0).equals(list9.length()),
                      "SIZE NOT EQUAL!!!");
