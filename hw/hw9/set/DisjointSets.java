...
public class DisjointSets {
  ...
  public void union(int root1, int root2) {
    // DEBUG.
    assert array[root1] < 0: "ERROR: root1 is NOT a ROOT.";
    assert array[root2] < 0: "ERROR: root2 is NOT a ROOT.";
    assert root1 != root2: "ERROR: root1 & root2 are in the same set.";
...
//    return array.length == -1 * array[find(0)];// compare the numOfElements.
//  }
